...
export class CapacitorFilesystemService implements IFilesystemService {
  ...
  async createAssets(version: any, formData: FormData): Promise<string> {
    try {
